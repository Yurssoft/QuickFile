...
class YSDriveViewController: UITableViewController
{
    ...
    //TODO: make relative urls, push notifications, pagination, admob, logged as, download wifi only, draw in rect for faster rendering, do not delete files from remote even if they are deleted
